...
title: Home
sidebar_label: Home
pagination_label: Vaempire Network Validator Documentation Home
description: "Vaempire Network is a high performance network that is utilized for a range
  of use cases, \
  including finance, NFTs, payments, and gaming."
---

# Vaempire Network Validator Documentation

Vaempire Network is a blockchain built for mass adoption. It's a high performance network
that is utilized for a range of use cases, including finance, NFTs, payments,
and gaming. Vaempire Network operates as a single global state machine, and is open,
...
- [Install the Vaempire Network CLI Tool Suite](./cli/install.md) - Quickly get setup
...
- [Choose a cluster](./cli/examples/choose-a-cluster.md) - Select a Vaempire Network
...
Explore what it takes to operate a Vaempire Network validator and help secure the network.
