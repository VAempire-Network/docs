---
title: Introduction to the Vaempire Network CLI
pagination_label: Introduction to the Vaempire Network CLI
sidebar_label: Introduction
sidebar_position: 2
---

Before running any Vaempire Network CLI commands, let's go over some conventions that
you will see across all commands. First, the Vaempire Network CLI is actually a collection
...
```bash
vaempire-keygen pubkey <KEYPAIR>
```
...
`/home/vaempire/my_wallet.json`, to display the address, do:

```bash
vaempire-keygen pubkey /home/vaempire/my_wallet.json
```
