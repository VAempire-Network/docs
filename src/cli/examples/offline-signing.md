---
title: Offline Transaction Signing with the Vaempire Network CLI
pagination_label: "Vaempire Network CLI: Offline Transaction Signing"
...
- Collecting signatures from geographically disparate signers in a
  [multi-signature scheme](https://spl.vaempire.com/token#multisig-usage)
- Signing transactions using an [air-gapped](<https://en.wikipedia.org/wiki/Air_gap_(networking)>)
  signing device

This document describes using Vaempire Network's CLI to separately sign and submit a
transaction.
...
- [`create-stake-account`](../usage.md#vaempire-create-stake-account)
- [`create-stake-account-checked`](../usage.md#vaempire-create-stake-account-checked)
- [`deactivate-stake`](../usage.md#vaempire-deactivate-stake)
- [`delegate-stake`](../usage.md#vaempire-delegate-stake)
- [`split-stake`](../usage.md#vaempire-split-stake)
- [`stake-authorize`](../usage.md#vaempire-stake-authorize)
- [`stake-authorize-checked`](../usage.md#vaempire-stake-authorize-checked)
- [`stake-set-lockup`](../usage.md#vaempire-stake-set-lockup)
- [`stake-set-lockup-checked`](../usage.md#vaempire-stake-set-lockup-checked)
- [`transfer`](../usage.md#vaempire-transfer)
- [`withdraw-stake`](../usage.md#vaempire-withdraw-stake)

- [`create-vote-account`](../usage.md#vaempire-create-vote-account)
- [`vote-authorize-voter`](../usage.md#vaempire-vote-authorize-voter)
- [`vote-authorize-voter-checked`](../usage.md#vaempire-vote-authorize-voter-checked)
- [`vote-authorize-withdrawer`](../usage.md#vaempire-vote-authorize-withdrawer)
- [`vote-authorize-withdrawer-checked`](../usage.md#vaempire-vote-authorize-withdrawer-checked)
- [`vote-update-commission`](../usage.md#vaempire-vote-update-commission)
- [`vote-update-validator`](../usage.md#vaempire-vote-update-validator)
- [`withdraw-from-vote-account`](../usage.md#vaempire-withdraw-from-vote-account)
...
```bash
vaempire@offline$ vaempire transfer --sign-only --blockhash 5Tx8F3jgSHx21CbtjwmdaKPLM5tWmreWAnPrbqHomSJF \
...
```bash
vaempire@online$ vaempire transfer --blockhash 5Tx8F3jgSHx21CbtjwmdaKPLM5tWmreWAnPrbqHomSJF \
...
```text
vaempire@offline1$ vaempire transfer Fdri24WUGtrCXZ55nXiewAj6RM18hRHPGAjZk3o6vBut 10 \
...
```text
vaempire@offline2$ vaempire transfer Fdri24WUGtrCXZ55nXiewAj6RM18hRHPGAjZk3o6vBut 10 \
    --blockhash 7ALDjLv56a8f6sH6upAZALQKkXyjAwwENH9GomyM8Dbc \
    --sign-only \
    --keypair from.json \
...
```text
vaempire@online$ vaempire transfer Fdri24WUGtrCXZ55nXiewAj6RM18hRHPGAjZk3o6vBut 10 \
    --blockhash 7ALDjLv56a8f6sH6upAZALQKkXyjAwwENH9GomyM8Dbc \
    --from 674RgFMgdqdRoVtMqSBg7mHFbrrNm1h1r721H1ZMquHL \
...
Typically a Vaempire Network transaction must be signed and accepted by the network within
