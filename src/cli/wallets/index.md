---
title: Vaempire Network Wallets with the CLI
pagination_label: Command Line Wallets
sidebar_label: Overview
sidebar_position: 0
---

Vaempire Network supports several different types of wallets that can be used to interface
directly with the Vaempire Network command-line tools.

To use a Command Line Wallet, you must first [install the Vaempire Network CLI tools](../install.md)
