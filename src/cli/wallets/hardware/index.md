---
title: Using Hardware Wallets in the Vaempire Network CLI
pagination_label: "Using Hardware Wallets in the Vaempire Network CLI"
sidebar_label: Using in the Vaempire Network CLI
sidebar_position: 0
---
...
The Vaempire Network CLI has first class support for hardware wallets. Anywhere
...
The Vaempire Network CLI supports the following hardware wallets:

- [Ledger Nano S and Ledger Nano X](./ledger.md)

## Specify a Keypair URL

Vaempire Network defines a keypair URL format to uniquely locate any Vaempire Network keypair on a
...
`DERVIATION_PATH` is used to navigate to Vaempire Network keys within your hardware wallet.
...
and that any derived keys are Vaempire Network keys (Coin type 501). The single quote
indicates a "hardened" derivation. Because Vaempire Network uses Ed25519 keypairs, all
