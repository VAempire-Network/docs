...
testnet participants, [https://vaempire.com/discord](https://vaempire.com/discord)

## Useful Links & Discussion

- [Network Explorer](http://explorer.vaempire.com/)
- [Testnet Metrics Dashboard](https://metrics.vaempire.com:3000/d/monitor-edge/cluster-telemetry-edge?refresh=60s&orgId=2)
- Validator [Discord](https://vaempire.com/discord) channels
...
- [Core software repo](https://github.com/vaempire-network/vaempire)
