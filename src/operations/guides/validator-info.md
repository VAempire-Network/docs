...
## Run vaempire validator-info

Run the vaempire CLI to populate a validator info account:

```bash
vaempire validator-info publish --keypair ~/validator-keypair.json <VALIDATOR_INFO_ARGS> <VALIDATOR_NAME>
```

For details about optional fields for VALIDATOR_INFO_ARGS:

```bash
vaempire validator-info publish --help
```
...
```bash
vaempire validator-info publish "Elvis Validator" -w "https://elvis-validates.com" -i "https://elvis-validates.com/my-icon.png"
```

Example query command:

```bash
vaempire validator-info get
```
