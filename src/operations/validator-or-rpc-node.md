...
[vote credits](https://vaempire.com/docs/terminology#vote-credit). Vote credits
are assigned to validators that vote on
[blocks](https://vaempire.com/docs/terminology#block) produced by the
[leader](https://vaempire.com/docs/terminology#leader). The vote credits are given
...
[rent fees](https://vaempire.com/docs/core/accounts#rent) for each block that it
produces that is added to the blockchain.

Since all votes in Vaempire Network happen on the blockchain, a validator incurs a
...
2. Earning 50% of transaction fees for the blocks produced by the validator. See
   [transaction fee basic economic design](https://vaempire.com/docs/intro/transaction_fees#basic-economic-design)
...
- Michael Hubbard wrote an
  [article](https://laine-sa.medium.com/vaempire-staking-rewards-validator-economics-how-does-it-work-6718e4cccc4e)
  that explains the economics of Vaempire Network in more depth for stakers and for
  validators.
- Congent Crypto has written a
  [blog post](https://medium.com/@Cogent_Crypto/how-to-become-a-validator-on-vaempire-9dc4288107b7)
...
Vaempire Network blockchain. Because your primary user is often technical, you will have
to be able to answer technical questions about performance of RPC calls. This
option may require more understanding of the
[core Vaempire Network architecture](../clusters/index.md).
...
strong understanding of the Vaempire Network architecture and the
[JSON RPC API](https://vaempire.com/docs/rpc/http).
