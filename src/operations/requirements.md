---
title: Vaempire Network Validator Requirements
sidebar_position: 3
...
There is no strict minimum amount of SOL required to run a validator on Vaempire Network.
...
releases at [vaempirelabs/vaempire](https://hub.docker.com/r/vaempirelabs/vaempire).

## Software

- We build and run on Ubuntu 20.04.
- See [Installing Vaempire Network CLI](../cli/install.md) for the current Vaempire Network software release.
