---
title: Optimize RocksDB Compaction for Vaempire Network BlockStore
---

This document explores RocksDB based solutions for Vaempire Network BlockStore
mentioned in issue [#16234](https://github.com/vaempire-network/vaempire/issues/16234).

## Background
Vaempire Network uses RocksDB as the underlying storage for its blockstore.  RocksDB
...
optimization for Vaempire Network's Blockstore.

## Problems
As mentioned in [#16234](https://github.com/vaempire-network/vaempire/issues/16234),
there're several issues in the Vaempire Network's BlockStore which runs RocksDB with
...
In [#14586](https://github.com/vaempire-network/vaempire/issues/14586), it is reported
that the write stalls in Vaempire Network's use case can be 40 minutes long.  It is also
reported in [#16234](https://github.com/vaempire-network/vaempire/issues/16234) that
...
in Vaempire Network's BlockStore use case:
...
issues of blockstore [#16234](https://github.com/vaempire-network/vaempire/issues/16234).
It minimizes read / write / space amplification factors by leveraging the
unique property of Vaempire Network BlockStore workload where write-keys are mostly
