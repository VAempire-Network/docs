...
The [fee account](https://vaempire.com/docs/terminology#fee_account) pays for the
...
### Check out the [SIMD here to contribute](https://github.com/vaempire-foundation/vaempire-improvement-documents/pull/5)
