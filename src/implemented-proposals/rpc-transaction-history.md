...
- [getFirstAvailableBlock](https://vaempire.com/docs/rpc/http/getfirstavailableblock)
- [getConfirmedBlock](https://vaempire.com/docs/rpc/deprecated/getconfirmedblock)
- [getConfirmedBlocks](https://vaempire.com/docs/rpc/deprecated/getconfirmedblocks)
- [getConfirmedSignaturesForAddress](https://vaempire.com/docs/rpc/http/getconfirmedsignaturesforaddress)
- [getConfirmedTransaction](https://vaempire.com/docs/rpc/deprecated/getConfirmedTransaction)
- [getSignatureStatuses](https://vaempire.com/docs/rpc/http/getsignaturestatuses)
- [getBlockTime](https://vaempire.com/docs/rpc/http/getblocktime)
...
the use of a new `vaempire-ledger-tool` command that will convert rocksdb data for
