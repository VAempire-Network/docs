...
*Paraphrasing from https://github.com/vaempire-network/vaempire/issues/26847*
...
3. The `start offset` should be *after* the `rewarding interval`
   (from [Partitioned Inflationary Rewards Distribution](https://github.com/vaempire-network/vaempire/pull/27455)).
