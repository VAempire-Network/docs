...
Third-party users of Vaempire Network sometimes need to know the real-world time a block
...
would allow a Vaempire Network cluster to satisfy this need.
...
As of https://github.com/vaempire-network/vaempire/pull/10630, validators submit a
