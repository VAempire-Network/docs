---
title: Vaempire Network ABI management process
---

This document proposes the Vaempire Network ABI management process. The ABI management
...
The Vaempire Network ABI (binary interface to the cluster) is currently only defined
...
```
VAEMPIRE_ABI_DUMP_DIR=. cargo +nightly test abi
```
